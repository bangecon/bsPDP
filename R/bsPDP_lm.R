##' Bootstrapped partial dependence plots for the \code{lm} estimator
##'
##' Evaluates a simple linear models for \code{n_boot} bootstrap iterations to obtain confidence bands for the estimated PDP.
##'
...
##' @param ... additional arguments for the \code{lm} function.
